                ...
                <div className="showblog_card card">
                    <div className="showblog_card_image"
                        ...
                        <div className="show_auth_img">
                            <Link to={"/public/" + post.user?.username} style={{ backgroundImage: `url(${post.user?.imagePath ? post.user.imagePath : avtar})` }}>User</Link>
                        </div>
                    </div>
...
=======
                       {/* <button type = "button" className = "btn-danger" to={"/post/delete/" + props._id}><span>Delete</span></button> */}
>>>>>>> a5d5bf3b01e45c75a3871755b8af05052b7fd140
