...
const App = (props) => {
  ...
  if (isLoading) {
    ...
    route = (<>
          ...
          {token ? <Route path="/profile/edit/:id" exact component={CreateProfile} /> : <Redirect to="/auth" />}
          {token ? <Route path="/post/delete/:id" exact component={SinglePost}/> : <Redirect to="/auth" />}
